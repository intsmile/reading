...
function getSwiperDesc(item){
    ...
    nHtml+='<div class="bb-1 center"><button type="button" class="layui-btn layui-btn-primary" ><a href="'+ip+"clickBook.html?id="+item.id+'">'+"书籍詳情"+'</a></button></div>'
    $("#bookDesc").html(nHtml)
}
